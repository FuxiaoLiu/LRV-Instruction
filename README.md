...
We run evaluation on [GQA](https://cs.stanford.edu/people/dorarad/gqa/download.html) dataset by randomly selecting 500 samples and evaluating by GPT4 (prompt [here]()).
