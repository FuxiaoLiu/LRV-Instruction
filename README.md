...
📺
[[LRV-V2(Mplug-Owl) Demo](https://a38a6af111e5194319.gradio.live)], [[mplug-owl Demo](https://huggingface.co/spaces/MAGAer13/mPLUG-Owl)]
<br>


📺
[[LRV-V1(MiniGPT4) Demo](https://231c5c264e14d2e70d.gradio.live)], [[MiniGPT4-7B Demo](https://845afff41e18071084.gradio.live)]



## Updates
- [8/16] 🔥 We release **180k** more visual instruction tuning data. You can download from [here](download.txt#L20).
...
We **update** the dataset with **155k + 180k** visual instructions generated by GPT4, covering 16 vision-and-language tasks with open-ended instructions and answers. LRV-Instruction include both positive instructions and negative instructions for more robust visual instruction tuning. The images of our dataset are from [Visual Genome](https://arxiv.org/pdf/1602.07332v1.pdf). Our data can be accessed in `data/filter_cap.json` or download from [here](download.txt#L5).
```
