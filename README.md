...
📺
[[LRV-V2(Mplug-Owl) Demo](https://ac1a611fc24a94aeb4.gradio.live)], [[mplug-owl Demo](https://huggingface.co/spaces/MAGAer13/mPLUG-Owl)]
<br>
...
## Updates
- [8/24] 🔥 We release some visual instruction data for chart images to increase the diversity of our dataset. [data](download.txt#L33) and [image](download.txt#L36)
...
| **Chart Instruction(More)** | [link](download.txt#L33) | [link](download.txt#L36) |
